...
class RoleAndLocationPolicy(unittest.TestCase):
    ...
    def test_filter_is_feed_aware_and_reports_stats(self):
        ...
        self.assertEqual(stats, {"company": 1, "seniority": 1, "domain": 1, "role": 0, "location": 1, "stale": 0})
        self.assertEqual({r["reason"] for r in rejected}, {"company", "seniority", "domain", "location"})
...
class MasterPolicy(unittest.TestCase):
    def test_empty_refresh_preserves_years_old_listing(self):
        old = role("https://x/retained", date_posted="2020-01-01",
